...
public class IndexActivity extends AppCompatActivity {
    ...
    private static final String PRODUCT_PATTERN = "^https:[/][/]www.mmwooo.com[/]categories[/](.+)[/]items[/](.+)$";
    private static final String CATEGORY_PATTERN = "^https:[/][/]www.mmwooo.com[/]categories[/]([^?]+)(?:[?]sort=(\\w+))?$";
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_VIEW.equals(action) && data != null) {
            ...
            if (productMatcher.matches()) {
                ...
                String sortName = categoryMatcher.group(2);
