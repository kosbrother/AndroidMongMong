...
public class StoreApi {
    ...
    public static List<County> getCounties() {
        ...
        Type type = new TypeToken<List<County>>() {
        }.getType();
    ...
    public static List<Town> getTowns(int countyId) {
        ...
        Type type = new TypeToken<List<Town>>() {
        }.getType();
        return new Gson().fromJson(message, type);
    }
    ...
    public static List<Road> getRoads(int countyId, int townId) {
        ...
        Type type = new TypeToken<List<Road>>() {
        }.getType();
        return new Gson().fromJson(message, type);
    }

    public static List<Store> getStores(int county_id, int town_id, int road_id) {
